# One dark October evening - Lesson 7
...
> I could not do it, but I did not ask for help.
...
1. **(to be) blue in the face** // до посинения
   ...
   > We can debate this until we're blue in the face // Мы можем спорить об этом до посинения. 
